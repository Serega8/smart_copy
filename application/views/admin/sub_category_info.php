<div class="wrapper">
    <table>
        <input type="hidden" id="ident" disabled value="<?= $category_info['id']; ?>"/>
        <tbody>
            <tr>
                <td><p>ID</p></td>
            ...
            <tr>
                <td>URL</td>
                <td><?= $_SERVER['SERVER_NAME']; ?>/catalog/<?= $level2; ?>/<input class="url" type="text" id="url_translit" value="<?= $category_info['translit_name']; ?>"/>
            ...
            <tr>
                <td><p>Применить изменения</p></td>
                <td><a id="apply_category" class="add" data-type="sub_category_edit">Применить</a></td>
            </tr>
        </tbody>
