...
<div class="wrapper">
    <table>
        <tbody>
            ...
            <tr>
                <td>URL</td>
                <td><?= $_SERVER['SERVER_NAME']; ?>/catalog/<input class="url" type="text" id="url_translit"/>
            ...
            <tr>
                ...
                <td><a id="apply_category" class="add" style="margin-left:0;" data-type="<?= $datatype; ?>">Применить</a></td>
            </tr>
        </tbody>
    </table>
</div>
